...
/* fullscreen*/ 
function fullScreenfullScreenmove(){

  if (videoElement.fullScreend){
    videoElement.fullScreend = false;
    fullScreenButton.style.backgroundImage = "url('./icons/fullScreen.svg')";

}
else{
  videoElement.fullScreend = true;
  fullScreenButton.style.backgroundImage = "url('./icons/fullScreenmove.svg')";

}
}

fullScreenButton.addEventListener("click", fullScreenfullScreenmove);
